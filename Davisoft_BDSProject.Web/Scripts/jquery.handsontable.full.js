...
(function ($, window, Handsontable) {
        ...
        var defaults = {
          ...
          resize = function () {
              ...
              if (defaults.minWidth > width) {
                  el.style.width = defaults.minWidth + 10 + 'px';
              } else if (width > defaults.maxWidth) {
                  el.style.width = defaults.maxWidth + 10 + 'px';
              } else {
              ...
              if (defaults.minHeight > scrollHeight) {
                  el.style.height = defaults.minHeight + 5 + 'px';
              } else if (defaults.maxHeight < scrollHeight) {
                  el.style.height = defaults.maxHeight + 5 + 'px';
                  el.style.overflowY = 'visible';
              } else {
                  el.style.height = scrollHeight + 5 + 'px';
              }
    ...
    WalkontableScroll.prototype.scrollToRenderedCell = function (TD) {
        ...
        if (this.instance.wtScrollbars.horizontal.scrollHandler !== window) {
            ...
            cellOffset.left -= 50 + Handsontable.Dom.offset(this.instance.wtScrollbars.horizontal.scrollHandler).left;
        }
