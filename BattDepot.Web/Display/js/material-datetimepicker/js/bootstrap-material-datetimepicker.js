(function($, moment)
{
	var pluginName = "bootstrapMaterialDatePickerCustom";
	var pluginDataName = "plugindatepicker_" + pluginName;
  	
  	moment.locale('en');

	function plugindatepicker(element, options)
	{
		this.currentView = 0;
	...
	$.fn[pluginName] = function(options, p)
	{
		this.each(function()
		{
			...
			{
			    $.data(this, pluginDataName, new plugindatepicker(this, options));
			}
			else
			{
	...
	plugindatepicker.prototype =
	{
		...
		{	
			...
			this._attachEvent(this.$element, 'focus', this._onFocusPopup.bind(this));
		},
		initDays: function()
		{
			this.days = [];
